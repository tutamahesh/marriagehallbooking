...
public class Hall {
	...
	public Hall(String id, String hallname, String location, int hallCapacity, int numberOfRooms,
			String electricalEquiptmentDetails, String houseKeepingDetails, double hallPrice, long contactNo) {
		super();
		this.id = id;
		this.hallname = hallname;
		this.location = location;
